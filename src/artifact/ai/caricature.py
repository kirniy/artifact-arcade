...
Edit the attached photograph in place as premium stylized 3D animation with tactile comic-print finishing. Preserve every real face, body proportion, pose, group relationship, and the recognizable real room behind them. Replace each guest's clothes from the neck down with a fitted athletic light coral-red-and-sky-blue suit made from textured technical fabric: black raised web lattice over the red torso and sleeves, pale sky-blue side panels and legs, subtle dark piping, integrated gloves, and a large clearly visible dark spider silhouette centered on the light chest panel; no letters. Every face, hairline, hairstyle, ears and expression must remain fully visible and uncovered; no mask, hood, helmet, eyewear or face paint. Build faces, bodies and environment as genuinely dimensional CGI with modeled volume, perspective depth, cinematic lensing, soft global illumination, volumetric rim light, believable material response and subtle depth of field; this must read as a frame from a high-budget 3D animated feature, not a flat drawing. Over that dimensional render add confident ink contours, halftone shadow fields, offset cyan/red print registration, stepped-motion echoes, paper grain, and sharp graphic light shapes. Use a bright scarlet, cobalt, warm ivory and limited black palette with readable midtones. Image 2 supplies event colors; the app adds the exact event emblem above the artwork, so do not generate any event badge. Do not invent franchise characters, studio names, other logos, or any extra readable text. Keep faces out of the lowest 13% for the app footer."""
]

SPIDERVERSE_SQUARE_VARIATIONS = [
    """DIMENSIONAL GRAPHIC-NOVEL MULTIVERSE — SQUARE 1:1
Rebuild the exact source guests and actual venue as a genuinely dimensional high-budget 3D animated still with modeled facial volume, natural adult anatomy, cinematic perspective, global illumination, volumetric rim light, material depth and subtle depth of field, while preserving precise identity. Replace clothes from the neck down with fitted light coral-red-and-sky-blue technical-fabric athletic suits carrying a raised black web lattice, pale blue side panels, fine piping and integrated gloves, but a large clearly visible dark spider silhouette centered on the light chest panel; no letters. Keep every real face, hairstyle and ear completely uncovered: no masks, hoods, helmets, eyewear or face paint. Finish the 3D frame with graphic ink contours, halftone texture, chromatic print separation and layered parallax. Bright scarlet, cobalt and warm ivory dominate; keep shadows readable. The app adds the exact Image 2 event emblem above the artwork; do not generate an event badge. No franchise character, studio mark, replacement location, fake lettering or additional text."""
]
...
- Image 2 is the exact canonical SPIDERVERSE event emblem, supplied for color/material reference only. The app adds the complete original emblem above your image. Do not generate any event emblem, badge or lettering yourself
...
- High quality artistic illustration, NOT pixel art, NOT photorealistic"""
  ...
  * The app adds exactly one complete original SPIDERVERSE emblem above the artwork; do not draw another event emblem
...
"""
            ...
            if is_spiderverse_style:
                image_style = "High-budget genuinely dimensional 3D animated-feature frame edited directly from the source photo; modeled facial volume, cinematic perspective and lensing, soft global illumination, volumetric rim light, believable materials and subtle depth of field; exact real uncovered faces and group preserved; every guest wears a fitted light coral-red-and-sky-blue technical-fabric athletic suit with raised black web lattice, pale blue side panels, fine piping and integrated gloves from the neck down; no masks, hoods, helmets, face paint, letters; recognizable real venue preserved; dimensional CGI under bold ink contours, offset cyan-red print registration, halftone fields, stepped-motion echoes, paper grain and layered parallax; event emblem added separately by the app, do not generate a badge; never a flat drawing; no franchise character, studio mark, extra text, dark void or generic replacement scene"
