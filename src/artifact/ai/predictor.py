...
=== ОБЯЗАТЕЛЬНО ВКЛЮЧИ ===
1. КОНКРЕТНОЕ микронаблюдение о ВНЕШНОСТИ с фото (миллиметры, проценты, углы): глаза, брови, улыбка, поза, одежда
2. ИСПОЛЬЗУЙ ОТВЕТЫ НА ВОПРОСЫ которые человек дал! Свяжи их с наблюдениями
3. Сделай неожиданный вывод из комбинации внешности + ответов
...
Format:
PREDICTION: [СТРОГО 65-70 слов в стиле жуткой машины с точными наблюдениями о внешности и ответах]
...
=== ОБЯЗАТЕЛЬНО ВКЛЮЧИ ===
1. КОНКРЕТНЫЕ детали ВНЕШНОСТИ с фото для основного сигнала: глаза, плечи, поза, выражение, одежда
2. ИСПОЛЬЗУЙ ОТВЕТЫ НА ВОПРОСЫ! Свяжи их с фоновой частотой
3. Как другие воспринимают этот сигнал (читаемость)
4. Текущий статус: краткое резюме и рекомендация
Начни с ПЕРЕВОД ВАЙБА ЗАВЕРШЕН.
...
Format:
PREDICTION: [СТРОГО 65-70 слов в стиле перевода вайба с деталями внешности и ответов]
TRAITS: [3-4 черты через запятую]
"""
...
=== ОБЯЗАТЕЛЬНО ВКЛЮЧИ ===
1. КОНКРЕТНЫЕ детали ВНЕШНОСТИ с фото как симптомы: глаза, выражение, поза, одежда
2. ИСПОЛЬЗУЙ ОТВЕТЫ НА ВОПРОСЫ как данные профиля! Анализируй их
3. Диагноз в псевдомедицинских терминах основанный на комбинации внешности + ответов
4. Рекомендация и прогноз
Начни с СКАНИРОВАНИЕ ЗАВЕРШЕНО. Закончи ВЫПИСАН.
...
Format:
PREDICTION: [СТРОГО 65-70 слов в медицинском формате с деталями внешности и ответов]
TRAITS: [3-4 черты через запятую]
"""
