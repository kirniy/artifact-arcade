...
Format:
PREDICTION: [60-80 слов в стиле жуткой машины с точными наблюдениями о внешности и ответах]
...
Format:
PREDICTION: [60-80 слов в стиле перевода вайба с деталями внешности и ответов]
TRAITS: [3-4 черты через запятую]
"""
...
Format:
PREDICTION: [60-80 слов в медицинском формате с деталями внешности и ответов]
TRAITS: [3-4 черты через запятую]
"""
