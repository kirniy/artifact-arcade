        ...
        try:
            ...
            try:
                ...
                if self._caricature and self._caricature.image_data:
                    ...
                    pre_info = pre_generate_upload_info("caricature", "png")
                    self._qr_url = pre_info.short_url
                    self._qr_image = generate_qr_image(pre_info.short_url)
                    logger.info(f"Pre-generated QR URL for ai_prophet: {self._qr_url}")
                    ...
                    prediction_text = self._prediction.text if hasattr(self._prediction, 'text') else str(self._prediction)
                    temp_print_data = {
                    ...
                    receipt = label_gen.generate_receipt("ai_prophet", temp_print_data)
