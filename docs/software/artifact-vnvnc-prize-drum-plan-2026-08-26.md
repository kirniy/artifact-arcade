...
- каждый из шести призов имеет вручную заданную крупную раскладку на одну–две строки; generic auto-shrink не используется;
...
Визуальная лента — не шесть карточек подряд и не сотни материализованных
секторов. Это один зацикленный барабан из 18 секторов: каждый из шести призов
встречается ровно три раза, порядок заново перемешивается на каждую выдачу,
